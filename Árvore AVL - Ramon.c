// Cria uma árvore binária de busca utilizando recursividade
// Percorre a árvore em ordem com a utlização de recursividade
...
void excluir(tp_no **raiz, tp_no *no, tp_no *paino) {
	...
	// Se o no não possui filhos, ou seja, e uma folha
	if ((no->esq == NULL) && (no->dir == NULL)) {
